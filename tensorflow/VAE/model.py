...
class MODEL:
    def __init__(self, LR, filter_num, batch_size, latent_size):
        ...
        self.img_full = tf.map_fn(img_preprocess, self.ori_x, dtype=tf.float32)   
    ...
    def main(self, img):    
        ...
        #img = tf.nn.tanh(tf.layers.batch_normalization(img, training = True))#64, 64, 3
        print(img.shape)
        return img
    ...
    def loss_function(self):
        ...
        #logpx_z = tf.losses.mean_squared_error(self.output, self.img_full)
