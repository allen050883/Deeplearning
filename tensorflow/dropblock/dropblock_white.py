...
class DropBlock2D_white(tf.keras.layers.Layer):
    def __init__(self, keep_prob, block_size, scale=True, **kwargs):
        super(DropBlock2D_white, self).__init__(**kwargs)
    ...
    def build(self, input_shape):
        ...
        self.set_keep_prob()
        super(DropBlock2D_white, self).build(input_shape)
